...
map <- isolates %>% leaflet() %>% addProviderTiles("CartoDB") %>% setView(lat = 52.520007, lng =13.404954, zoom = 1)
map1 <- map %>%
  addPolylines(lat = c(55.0000, 53.6000, 53.51885, 52.8875  , 52.6053, 51.8978, 45.0000), 
               lng = c(10.0000, 11.4563, 12.4464,13.8119 , 13.8756, 13.8103, 10.0000), 
               color = "purple", 
               weight = 10, 
               opacity = 0.4) %>%
  addCircleMarkers(data = isolates,
                   col = "black",
                   opacity = 1,
                   radius = 4,
                   group = "Background") %>%
...
a <- ggplot(var_miss_04, aes(fmiss)) + geom_density(fill = "lightblue",      colour = "black", alpha = 0.3) + theme_light()
b <- ggplot(var_miss_05, aes(fmiss)) + geom_density(fill = "cornflowerblue", colour = "black", alpha = 0.3) + theme_light()
c <- ggplot(var_miss_06, aes(fmiss)) + geom_density(fill = "orange",         colour = "black", alpha = 0.3) + theme_light()
d <- ggplot(var_miss_07, aes(fmiss)) + geom_density(fill = "yellow",         colour = "black", alpha = 0.3) + theme_light()
e <- ggplot(var_miss_12, aes(fmiss)) + geom_density(fill = "green",          colour = "black", alpha = 0.3) + theme_light()

fig3 <- ggarrange(a,b,c,d,e, ncol = 3, nrow = 2, 
                  labels = c('04_samples', '05_samples', '06_samples', '07_samples', 
                             '12_samples'))
fig3
```
...
a <- ggplot(var_freq_04, aes(maf)) + geom_density(fill = "lightblue",      colour = "black", alpha = 0.3) + theme_light()
b <- ggplot(var_freq_05, aes(maf)) + geom_density(fill = "cornflowerblue", colour = "black", alpha = 0.3) + theme_light()
c <- ggplot(var_freq_06, aes(maf)) + geom_density(fill = "orange",         colour = "black", alpha = 0.3) + theme_light()
d <- ggplot(var_freq_07, aes(maf)) + geom_density(fill = "yellow",         colour = "black", alpha = 0.3) + theme_light()
e <- ggplot(var_freq_12, aes(maf)) + geom_density(fill = "green",          colour = "black", alpha = 0.3) + theme_light()

fig4 <- ggarrange(a,b,c,d,e, ncol = 3, nrow = 2, 
                  labels = c('04_samples', '05_samples', '06_samples', '07_samples', '12_samples'))
fig4
```
...
a <- ggplot(ind_depth_04, aes(depth)) + geom_histogram(fill = "lightblue",      colour = "black", alpha = 0.3) + theme_light()
b <- ggplot(ind_depth_05, aes(depth)) + geom_histogram(fill = "cornflowerblue", colour = "black", alpha = 0.3) + theme_light()
c <- ggplot(ind_depth_06, aes(depth)) + geom_histogram(fill = "orange",         colour = "black", alpha = 0.3) + theme_light()
d <- ggplot(ind_depth_07, aes(depth)) + geom_histogram(fill = "yellow",         colour = "black", alpha = 0.3) + theme_light()
e <- ggplot(ind_depth_12, aes(depth)) + geom_histogram(fill = "green",          colour = "black", alpha = 0.3) + theme_light()

fig5 <- ggarrange(a,b,c,d,e, ncol = 3, nrow = 2, 
                  labels = c('04_samples', '05_samples', '06_samples', '07_samples', '12_samples'))
fig5
```
...
a <- ggplot(ind_miss_04, aes(fmiss)) + geom_histogram(fill = "lightblue",      colour = "black", alpha = 0.3) + theme_light()
b <- ggplot(ind_miss_05, aes(fmiss)) + geom_histogram(fill = "cornflowerblue", colour = "black", alpha = 0.3) + theme_light()
c <- ggplot(ind_miss_06, aes(fmiss)) + geom_histogram(fill = "orange",         colour = "black", alpha = 0.3) + theme_light()
d <- ggplot(ind_miss_07, aes(fmiss)) + geom_histogram(fill = "yellow",         colour = "black", alpha = 0.3) + theme_light()
e <- ggplot(ind_miss_12, aes(fmiss)) + geom_histogram(fill = "green",          colour = "black", alpha = 0.3) + theme_light()
