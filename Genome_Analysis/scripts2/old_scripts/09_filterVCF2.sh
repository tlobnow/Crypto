...
VCF_OUT=~/Documents/Github/Crypto/Genome_Analysis/products/vcfFiltered/07_samples_stats2.vcf.gz
...
VCF_OUT=~/Documents/Github/Crypto/Genome_Analysis/products/vcfFiltered/18_samples_stats2.vcf.gz
